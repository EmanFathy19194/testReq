                                ...
                                <div className="col-lg-3 col-sm-6">
                                    <div className="card-contact">
                                        ...
                                        <div className="card-info">
                                            ...
                                            <div className="card-method-contact"> <Link className="email text-sm-bold" href="/mailto:support@alithemes.com">support@lorem.com</Link></div>
                                        </div>
                                    </div>
                                </div>
                                <div className="col-lg-3 col-sm-6">
                                    <div className="card-contact">
                                        ...
                                        <div className="card-info">
                                            ...
                                            <div className="card-method-contact"> <Link className="email text-sm-bold" href="/tel:(+01) 234 567 89">(+02) 00000-  000000</Link></div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div className="card-contact">
                                        ...
                                        <div className="card-info">
                                            <div className="card-title">
                                                <Link className="title text-lg-bold" href="#">Physical Address</Link>
                                                <p className="text-xs-medium neutral-500">Lorem ipsum dolor sit amet, consectetur adipiscing elit</p>
                                            </div>
                                            <div className="card-method-contact">
                                                <p className="address text-sm-bold">Lorem Ipsum, Amet, Country</p>
                                            </div>
                                        </div>
                                                ...
                                                <div className="form-group">
                                                    <div className="remeber-me">
                                                        <label className="text-sm-medium neutral-500">
                                                            <input className="cb-remember" type="checkbox" />Agree to our <Link className="text-sm-bold text-request" href="/term">Terms of service </Link>and <Link className="text-sm-bold text-request" href="/privacy">Privacy Policy</Link>
                                                        </label>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div className="col-lg-5 mb-30">
                                    <div className="banner-contact">
                                        <div className="row">
                                            ...
                                            <div className="col-sm-6">
                                                <div className="banner-img-contact">
                                                    <div className="box-traveled-in">
                                                        <p className="text-xl-medium mb-20">1684 people used <strong>Request </strong>in the last <strong>24 hours</strong></p>
                                            ...
                                            <div className="col-sm-6">
                                                <div className="banner-img-contact"> <img className="bdrd-16" src="/assets/imgs/page/pages/banner-contact2.png" alt="Request" /></div>
