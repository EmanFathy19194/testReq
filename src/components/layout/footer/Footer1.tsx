                ...
                <div className="container">
                    <div className="row">
                        <div className="col-lg-4 col-sm-12">
                            <div className="mb-20"><Link className="d-inline-block mb-20" href="/"><img alt="Request.com" src="/assets/imgs/Request/request_white.png" className="w-85"/></Link>
                                <div className="box-info-contact mt-0">
                                    <p className="text-md color-white">Unlock real-time pricing and unbeatable travel services—built for today’s tourism leaders.</p>
                                    <p className="text-md neutral-400 icon-address">1234 Lorem Street, Ipsum City, Dolor 56789
                                    </p>
                                    <p className="text-md neutral-400 icon-email">support@request.com</p>
                                </div>
                            </div>
                        </div>
                        <div className="col-lg-5 mt-30">
                            <div className="row">
                                ...
                                <div className="col-md-6 col-sm-6">
                                    <h6>Services</h6>
                                    <ul className="menu-footer">
                                        <li><Link href="#">Hotel Pricing </Link></li>
                                        <li><Link href="#">Internal Trip Comparison</Link></li>
                                        <li><Link href="#">Transportation </Link></li>
                                        <li><Link href="#">Smart Tour Planning</Link></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        <div className="col-lg-3 mt-30">
                            ...
                            <p className="text-md neutral-400 mb-15">Subscribe to our newsletter for the latest updates</p>
                    ...
                    <div className="footer-bottom mt-50">
                        <div className="row align-items-center">
                            <div className="col-md-6 text-md-start text-center mb-20">
                                <p className="text-sm color-white">Copyright © {new Date().getFullYear()} MyTravel. All Rights Reserved. Developed By: <a href='https://www.solvytix.com' target='_blank'>Solvytix</a> </p>
                            </div>
