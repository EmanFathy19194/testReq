			...
			<section className="section-box box-filter-search background-body">
				<div className="container">
					<div className="block-filter-search">
						...
						<div className="filter-right p-10">
							<Link className="category-link btn-click active" href="#">Accommodation</Link>
							<Link className="category-link btn-click" href="#">Domestic Trips</Link>
							<Link className="category-link btn-click" href="#">Tourist Transport</Link>
							<Link className="category-link btn-click" href="#">Limousine</Link>
						</div>
					</div>
