...
import { swiperGroupAnimate } from '@/util/swiperOption'; // Ensure this is valid
                                ...
                                <SwiperSlide>
                                    <div className="card-walking background-card">
                                        <div className="card-info">
                                            <h4>Waking up <br className="d-none d-lg-block" />in a far away place</h4>
                                            <Link className="btn btn-brand-secondary" href="#">View More
